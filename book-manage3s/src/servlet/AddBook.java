...
public class AddBook extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (bookDao.findBookById(request.getParameter("bookid")) != null) {
				request.setAttribute("msg", "book id÷ÿ∏¥£°");
			} else {
				Book book = new Book();
			...
			request.getRequestDispatcher("queryBook").forward(request, response);
		} catch (Exception e) {
